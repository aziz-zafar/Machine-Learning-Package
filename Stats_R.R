...
data = read.csv("stats_copy_merged.csv")
...
columns_grouped = list(c('ADD'),
c('ASTL6A'), c('CHBED6A'), c('CHMAT6A'), c('DEWOR6A'), c('FAAS6A'), c('FAHAY6A'),
c('FAWHEZ6A'), c('GCAT'), c('GCOOK6A'), c('GCOW'), c('GDOG'), c('GFLOOR6A'), c('GHEN'),
c('GHORSE'), c('GPIG'), c('GROOF6A'), c('GSHEEP'), c('GTOLIET6A'), c('GWALL6A'), c('HAYF6A'),
c('HAYFL6A'), c('HCIGR6A'), c('HCT'), c('HGB'), c('MaternalEdc'), c('MCH'), c('MCHC'), c('MCV'),
c('MOAS6A'), c('MOHAY6A'), c('PLT'), c('RASHL6A'), c('RBC'), c('Sex'), c('WBC'), c('WHZL6A'),
c('Age_1.0', 'Age_2.0'), c('CHSLP6A'), c('DP'), c('FamilySize_1.0', 'FamilySize_2.0'),
c('GAPPD'),
c('GCPOS'), c('GCHAR_1.0', 'GCHAR_2.0'), c('GDUNG_1.0', 'GDUNG_2.0'),
c("GNAF_1.0", "GNAF_2.0"),
c('GELEC_1.0', 'GELEC_2.0'), c('GGAS_1.0', 'GGAS_2.0'), c('GLEAVES_1.0',
'GLEAVES_2.0'), c('GWATER6A_1.0', 'GWATER6A_2.0'),
c('GWOOD_1.0', 'GWOOD_2.0'), c('LYM_1.0', 'LYM_2.0'), c('MaternalOcc_1.0',
'MaternalOcc_2.0'), c('MOWHZ6A'), c('GWASTE6A_1.0',
'GWASTE6A_2.0'))

#this is the vector with all the columns, for multivariate analysis.

columns = c('ADD','ASTL6A', 'CHBED6A', 'CHMAT6A', 'DEWOR6A', 'FAAS6A', 'FAHAY6A',
'FAWHEZ6A', 'GCAT', 'GCOOK6A', 'GCOW', 'GDOG', 'GFLOOR6A', 'GHEN',
'GHORSE', 'GPIG', 'GROOF6A', 'GSHEEP', 'GTOLIET6A', 'GWALL6A', 'HAYF6A',
'HAYFL6A', 'HCIGR6A', 'HCT', 'HGB', 'MaternalEdc', 'MCH', 'MCHC', 'MCV',
'MOAS6A', 'MOHAY6A', 'PLT', 'RASHL6A', 'RBC', 'Sex', 'WBC', 'WHZL6A',
'Age_1.0', 'Age_2.0', 'CHSLP6A', 'DP', 'FamilySize_1.0',
'FamilySize_2.0', 'GAPPD', 'GCPOS','GCHAR_1.0', 'GCHAR_2.0',
'GDUNG_1.0', 'GDUNG_2.0',
"GNAF_1.0", "GNAF_2.0",'GELEC_1.0', 'GELEC_2.0',
"GGAS_1.0","GGAS_2.0",'GLEAVES_1.0',
'GLEAVES_2.0', 'GWATER6A_1.0', 'GWATER6A_2.0',
'GWOOD_1.0', 'GWOOD_2.0', 'LYM_1.0', 'LYM_2.0', 'MaternalOcc_1.0',
'MaternalOcc_2.0', 'MOWHZ6A', 'GWASTE6A_1.0',
'GWASTE6A_2.0')
...
write.csv(cbind(attr((model_logi_STH$terms), "term.labels"),
                summary(model_logi_STH)$coefficients[1:length(columns)+1,],
...
write.csv(cbind(attr((model_logi_Par$terms), "term.labels"),
                summary(model_logi_Par)$coefficients[1:length(columns)+1,],
...
write.csv(cbind(attr((model_logi_Prot$terms), "term.labels"),
                summary(model_logi_Prot)$coefficients[1:length(columns)+1,],
...
write.csv(cbind(attr((model_logi_Helm$terms), "term.labels"),
                summary(model_logi_Helm)$coefficients[1:length(columns)+1,],
